...
const std::string BONUS_MEDKIT_FILE_NAME{ "med.png" };
const std::string BONUS_SPEED_BOOST_FILE_NAME{ "RED_BULL.png" };
const std::string BONUS_KABOOM_FILE_NAME{ "Gadget.png" };
